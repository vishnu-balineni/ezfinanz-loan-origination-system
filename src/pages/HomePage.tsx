...
import {
    Clock, CheckCircle2, ChevronRight, LogOut,
    Banknote, Calendar, ShieldAlert, Sparkles, User, HelpCircle, FileText
} from 'lucide-react';
import './HomePage.css';
...
const HomePage = () => {
    ...
    const handleLogout = () => {
        // Purge session locally then return to Auth
        navigate('/');
    };
        ...
        <div className="dashboard-container">
            ...
            <nav className="dashboard-navbar">
                <div className="brand-section">
                    ...
                    <span className="brand-name">EZFINANZ</span>
                </div>
